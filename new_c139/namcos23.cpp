...
protected:
	...
	required_device<namco_c139_device> m_c422;
...
void namcos23_state::c422_int_w(int state)
{
...
void gorgon_state::mips_map(address_map &map)
{
	...
	map(0x0f200000, 0x0f203fff).m(m_c422, FUNC(namco_c139_device::data_map)); // C422 RAM
	map(0x0f300000, 0x0f30000f).m(m_c422, FUNC(namco_c139_device::regs_map)); // C422 registers
}
...
void namcos23_state::mips_map(address_map &map)
{
	...
	map(0x06200000, 0x06203fff).m(m_c422, FUNC(namco_c139_device::data_map)); // C422 RAM
	map(0x06400000, 0x0640000f).m(m_c422, FUNC(namco_c139_device::regs_map)); // C422 registers
...
void crszone_state::mips_map(address_map &map)
{
	...
	map(0x16200000, 0x16203fff).m(m_c422, FUNC(namco_c139_device::data_map)); // C422 RAM
	map(0x16400000, 0x1640000f).m(m_c422, FUNC(namco_c139_device::regs_map)); // C422 registers
...
void gorgon_state::gorgon(machine_config &config)
{
	...
	NAMCO_C139(config, m_c422, 0U);
	m_c422->irq_cb().set(FUNC(gorgon_state::c422_int_w));
}
...
void namcos23_state::s23(machine_config &config)
{
	...
	NAMCO_C139(config, m_c422, 0U);
	m_c422->irq_cb().set(FUNC(namcos23_state::c422_int_w));
}
